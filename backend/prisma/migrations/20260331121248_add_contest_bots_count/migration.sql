...
INSERT INTO "new_contests" ("createdAt", "createdBy", "description", "endAt", "id", "maxPlayers", "name", "slug", "startAt", "status", "type", "updatedAt") SELECT "createdAt", "createdBy", "description", "endAt", "id", "maxPlayers", "name", "slug", "startAt", "status", "type", "updatedAt" FROM "contests";
DROP TABLE "contests";
